...
public class ConsolaOlimpicos
{
	...
	private void ejecutarBuscarAtletaNombre() 
	{
		System.out.println("\n" + "Pais del atleta consultado" + "\n");
		String nom = input("Por favor ingrese el nombre de un atleta");
		Pais paisAtleta = calculadora.buscarAtletaNombre(nom);
		String nombrePais = paisAtleta.darNombre();
		System.out.println("El pais del atleta consultado es " + nombrePais);
	}
	...
	/**
	 * Muestra al usuario la informacion del atleta que queire consultar por su nombre
	 */
